...
@section('title', 'Política de Privacidad — ' . ($tenantTitle ?? config('app.name')))

@section('content')
<div class="container py-5" style="max-width: 800px;">

    <h1 class="mb-1 fw-bold">Política de Privacidad</h1>
    <p class="text-muted mb-4">Última actualización: {{ now()->translatedFormat('d \d\e F \d\e Y') }}</p>

    <p>
        Esta Política de Privacidad describe cómo <strong>{{ $tenantTitle ?? config('app.name') }}</strong>
        (@if(!empty($tenantEmail))<a href="mailto:{{ $tenantEmail }}">{{ $tenantEmail }}</a>@else
        contacto a través de nuestro sitio web@endif)
    ...
    <h2 class="h4 mt-5 mb-3">1. Información que recopilamos</h2>
    <p>Podemos recopilar los siguientes tipos de información:</p>
    <ul>
        <li><strong>Datos de contacto:</strong> nombre, correo electrónico, número de teléfono.</li>
        <li><strong>Datos de perfil de Meta:</strong> nombre público e identificador de usuario de Facebook o Instagram, cuando usted inicia sesión o interactúa con nosotros a través de esas plataformas.</li>
    ...
    <h2 class="h4 mt-5 mb-3">2. Cómo usamos su información</h2>
    <ul>
    ...
    <h2 class="h4 mt-5 mb-3">3. Integración con Meta (Facebook e Instagram)</h2>
    <p>
    ...
    <h2 class="h4 mt-5 mb-3">4. Eliminación de sus datos</h2>
    <p>
    ...
    {{-- ── 5. Seguridad ── --}}
    <h2 class="h4 mt-5 mb-3">5. Seguridad de la información</h2>
    <p>
    ...
    {{-- ── 6. Cookies ── --}}
    <h2 class="h4 mt-5 mb-3">6. Cookies</h2>
    <p>
    ...
    <h2 class="h4 mt-5 mb-3">7. Cambios a esta política</h2>
    <p>
    ...
    {{-- ── 8. Contacto ── --}}
    <h2 class="h4 mt-5 mb-3">8. Contacto</h2>
