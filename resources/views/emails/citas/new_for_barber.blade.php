    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f6f7fb;padding:24px 0;">
        <tr>
            <td align="center">
                    ...
                    <tr>
                        <td style="padding:28px 28px 8px 28px">
                            <h1 style="margin:0 0 8px 0;font-size:22px;line-height:1.3;">
                                Nueva cita para {{ $barberoNombre }}
                            </h1>
                            <p style="margin:0;color:#4b5563;font-size:15px;line-height:1.6">
                                Se registró una cita desde el sitio con los siguientes detalles:
                            </p>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding:18px 20px">
                                        <div style="font-size:15px;line-height:1.6;color:#111">
                                            <div style="margin-bottom:6px"><strong>Cliente:</strong>
                                                {{ $clienteNombre }}</div>
                                            ...
                                            <div style="margin:10px 0 6px 0">
                                                <strong>Fecha:</strong> {{ $fechaHuman }} ·
                                                <strong>Hora:</strong> {{ $horaHuman }} ({{ $duracionMin }} min)
                                            </div>
                    ...
                    <tr>
                        <td style="padding:16px 28px 0 28px">
                            <div style="text-align:center;padding:8px 0 16px 0">
                                <a href="{{ $adminShowUrl }}" target="_blank"
                        ...
                        padding:12px 18px;border-radius:10px;font-weight:600">
                            ...
                            <p style="margin:0 0 16px 0;color:#6b7280;font-size:13px;line-height:1.6;text-align:center">
                                Puedes gestionar las citas desde el panel.
                            </p>
                        </td>
                    </tr>
                ...
                <div style="color:#9ca3af;font-size:12px;margin-top:12px">© {{ date('Y') }} — Agenda Barbería</div>
            </td>
        </tr>
    </table>
</body>
