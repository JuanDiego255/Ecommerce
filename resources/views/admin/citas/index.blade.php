...
@section('content')
    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <div style="font-size:.78rem;color:#6c757d;margin-top:-8px;margin-bottom:4px;">
                <i class="material-icons" style="font-size:.85rem;vertical-align:middle;">info</i>
                Mostrando <strong>{{ $citas->count() }}</strong> cita(s) de <strong>{{ $months[$month] ?? $month }}</strong>.
            </div>
