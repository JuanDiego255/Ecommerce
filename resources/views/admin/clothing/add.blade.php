                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="input-group input-group-static mb-4">
                                ...
                                <input readonly value="{{ $category_name }}" type="text" class="form-control form-control-lg" name="category">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="input-group input-group-static mb-4">
                                ...
                                <input required type="text" class="form-control form-control-lg" name="name" value="{{ old('name') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="input-group input-group-static mb-4">
                                <label> {{ __('Casa') }}</label>
                                <input type="text" class="form-control form-control-lg" name="casa" value="{{ old('casa') }}">
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check form-switch col-md-6">
                                <input value="1" checked class="form-check-input" type="checkbox" name="manage_stock"
                                    id="manage_stock">
                                <label class="form-check-label"
                                    for="manage_stock">{{ __('Maneja Stock') }}</label>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="input-group input-group-static mb-4">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="input-group input-group-static mb-4">
                                <textarea id="editor" type="text" class="form-control form-control-lg" name="description" placeholder="Descripción del producto">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="input-group input-group-static mb-4">
                                ...
                                <input required type="number" class="form-control form-control-lg" name="price" value="{{ old('price') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="input-group input-group-static mb-4">
                                ...
                                <input type="number" class="form-control form-control-lg" name="mayor_price" value="{{ old('mayor_price') }}">
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="input-group input-group-static mb-4">
                                ...
                                <input type="number" class="form-control form-control-lg" name="discount" value="{{ old('discount') }}">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="input-group input-group-static mb-4">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="masive" name="masive" {{ old('masive') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="can_buy" name="can_buy" {{ old('can_buy') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="trending" name="trending" {{ old('trending') ? 'checked' : '' }}>
                                <label class="custom-control-label" for="customCheck1">{{ __('Tendencia') }}</label>
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label class="form-label">{{ __('Meta Keywords (Opcional - Presione enter para agregar la palabra clave)') }}</label><br>
                            <div class="tags-input">
                                <ul id="tags">
                                    @if (old('meta_keywords'))
                                    @foreach (explode(',', old('meta_keywords')) as $keyword)
                                    <li>{{ $keyword }}<span class="tag-remove" onclick="removeTag(this)">&times;</span></li>
                                    @endforeach
                                    @endif
                                </ul>
                                <input type="text" id="input-tag" placeholder="Escriba la palabra clave.." />
                                <input type="hidden" value="{{ old('meta_keywords') }}" id="meta_keywords" name="meta_keywords">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 mb-2">
                            <div class="input-group input-group-static">
                                ...
                                <select id="attr_id" name="attr_id" class="form-control form-control-lg @error('attr_id') is-invalid @enderror" autocomplete="attr_id" autofocus>
                                    ...
                                    <option value="{{ $item->id }}" {{ old('attr_id') == $item->id ? 'selected' : '' }}>
                                        {{ $item->name }}
                                    </option>
                                    @endforeach
                                </select>
    ...
    $(document).ready(function() {
        ...
        function toggleStockQuantityField() {
            if (manageStockCheckbox.checked) {
                ...
                var advertContent = "Si deshabilitas el stock, se colocará un -1 (Indica que no maneja stock) en la cantidad de cada uno de los atributos, si deseas deshacer esta opción debes habilitar el switch de Maneja Stock, eliminar y volver a agregar cada atributo.";
                Swal.fire({
                    title: 'Aviso!',
                    html: advertContent,
                    icon: "info",
