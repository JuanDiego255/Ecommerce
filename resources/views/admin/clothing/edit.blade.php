                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input id="stock" min="1" required
                                        @if ($tenantinfo->manage_size != 0) readonly @endif
        ...
        $(document).ready(function() {
                ...
                attributes.forEach(function(item, index) {
                    if (item.attr_id != null && item.attr_id != "") {
                        ...
                        if (!document.getElementById(precioId) && !document.getElementById(cantidadId) && !
                            ...
                            if (!startup) {
                                if (manage) {
                                    document.getElementById(cantidadId).value = item.stock > 0 ? item
                                        .stock : 1;
                                } else {
            ...
            function toggleStockQuantityField() {
                if (manageStockCheckbox.checked) {
                    ...
                    var advertContent =
                        "Al habilitar el stock, tomará por defecto los valores que ya existían en el producto. Si el valor es negativo el sistema sugerirá un valor mayor a 0";
                    Swal.fire({
                        title: 'Aviso!',
                        html: advertContent,
                        icon: "info",
                    ...
                    var advertContent =
                        "Al deshabilitar el stock, tomará por defecto los valores que ya existían en el producto, pero les establecerá un -1";
                    Swal.fire({
                        title: 'Aviso!',
                        html: advertContent,
                        icon: "info",
