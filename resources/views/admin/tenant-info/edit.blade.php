                ...
                <form class="form-horizontal" action="{{ url('tenant-info/update/' . $item->id) }}" method="post"
                    ...
                    <div class="col-md-12">
                        <div
                            ...
                            <textarea placeholder="Misión: Esta misión se mostrará en la sección de Misión en la página principal"
                                 required type="text"
                                class="form-control form-control-lg @error('mision') is-invalid @enderror" name="mision" id="mision">{{ isset($item->mision) ? $item->mision : '' }}</textarea>
                            @error('mision')
                                <span class="invalid-feedback" role="alert">
                                    <strong>Campo Requerido</strong>
                                </span>
                        ...
                        <div
                            ...
                            <textarea
                                placeholder="Descripción Tendencia: Esta descripción se mostrará en la sección de artículos en tendencia en la página principal"
                                 type="text"
                                class="form-control form-control-lg @error('title_trend') is-invalid @enderror" name="title_trend" id="title_trend">{{ isset($item->title_trend) ? $item->title_trend : '' }}</textarea>
                            @error('title_trend')
                                <span class="invalid-feedback" role="alert">
                                    <strong>Campo Requerido</strong>
                                </span>
                    ...
                    <div class="col-md-12">
                        <div
                            ...
                            <label class="form-label">Descripción suscripción: esta descripción es el cuerpo del mensaje
                                que incita al
                    ...
                    <div class="col-md-12">
                        <div
                            ...
                            <label class="form-label">Pie de página: esta descripción es el pie de página, normalmente
