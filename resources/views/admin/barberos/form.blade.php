<div class="row">
    ...
    <div class="col-md-6">
        <div class="input-group input-group-lg input-group-outline is-filled my-3">
            <label class="form-label">Tiempo extra entre citas</label>
            <input type="number" name="buffer_minutes" class="form-control form-control-lg" min="0"
                step="5" value="{{ old('buffer_minutes', $barbero->buffer_minutes ?? 0) }}">
        </div>
    </div>
    <div class="col-md-6">
        <div class="input-group input-group-lg input-group-outline is-filled my-3">
