    ...
    @switch($tenantinfo->tenant)
            ...
            <div class="container">
                ...
                <div class="gift-card mb-5">
                    <h1 class="sakura-font">Disfruta de la flexibilidad de nuestras tarjetas de regalo para canjear en cualquier
                        producto.</h1>
                    <button class="gift-button sakura-font" type="button" data-bs-toggle="modal"
                        data-bs-target="#gift-card-modal">Obtener
                        Tarjeta
                        de Regalo</button>
                </div>
                @if (count($tenantcarousel) != 0)
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner mb-1 foto mt-5">
                        ...
                        @if (count($category) != 0)
                            <div>
                                <h1 class="mt-5 mb-5 sakura-20 sakura-color">
                                    No te pierdas la oportunidad de encontrar tú producto favorito explorando en nuestras categorías
                                </h1>
                            </div>
                        @endif
                        <div class="row">
                ...
                @if (count($clothings_offer) != 0)
                    ...
                    <div class="container-fluid mb-5 offer animado">
                        <div class="text-center">
                            <h3 class="text-center sakura-font text-muted mt-5 mb-4">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="product-grid-offer">
                                        ...
                                        <div class="product-content-offer">
                                            <a class="add-to-cart sakura-font"
                                                href="{{ url('clothes-category/' . $item->category_id) }}">
                                                <i class="fas fa-plus"></i>Más ofertas
                                            </a>
                                            <h3
                                                class="text-muted sakura-font text-uppercase {{ isset($tenantinfo->tenant) && $tenantinfo->tenant != 'fragsperfumecr' ? 'd-none' : '' }}">
                                                {{ $item->casa }}
                                            </h3>
                                            <h3 class="title sakura-font clothing-name">
                                            ...
                                            @if (isset($tenantinfo->show_stock) && $tenantinfo->show_stock != 0)
                                                <h4 class="title sakura-font">
                                                    Stock:
                                                    @if ($item->total_stock > 0)
                                                        {{ $item->total_stock }}
                                                    @elseif ($item->total_stock == 0)
                                                        <s class="text-danger sakura-font">0</s>
                                                    @else
                                                        <span class="text-info sakura-font">Sin manejo de stock</span>
                                                    @endif
                                                </h4>
                                            @endif
                                            @php
                                                ...
                                                $precioConDescuento = $precio - $descuento;
                                            @endphp
                                            <div class="price sakura-font">₡{{ number_format($precioConDescuento) }}
                                                @if ($item->discount)
                                                    <s class="text-danger sakura-font"><span
                                                            class="text-danger sakura-font">₡{{ number_format(Auth::check() && Auth::user()->mayor == '1' && $item->mayor_price > 0 ? $item->mayor_price : $item->price) }}
                                                        </span></s>
                                                @endif
                                            </div>
                                        </div>
                ...
                {{--    @if (isset($tenantinfo->show_insta) && $tenantinfo->show_insta == 1)
                    ...
                    <div class="text-center animado">
                        <span class="text-muted text-center">
                            ...
                            <a class="sakura-font" href="{{ isset($instagram) ? $instagram : '' }}">Siguenos en nuestras redes
                                sociales <i class="fab fa-instagram"></i></a>
                            @if ($facebook)
                                | <a class="sakura-font" href="{{ isset($facebook) ? $facebook : '' }}"><i
                ...
                {{-- @if (count($blogs) != 0)
                    ...
                    <div class="mt-3 mb-5 animado">
                        <div class="container-fluid">
                            <div class="text-center">
                                <h3 class="text-center text-muted mt-5 sakura-font mb-3">Blog de
                                            ...
                                            <div class="product-grid product_data">
                                                <div class="product-image">
                                                    ...
                                                    <a href="{{ url('/blog/' . $item->id . '/' . $item->name_url) }}"
                                                        class="add-to-cart sakura-font">Ver
                                                        información</a>
                                                </div>
                ...
                @if (count($comments) != 0)
                    ...
                    <div class="mt-3 mb-5 animado">
                        <div class="container">
                            <div class="text-center">
                                <h3 class="text-center sakura-color sakura-font mt-5 mb-3">Testimonios de nuestros clientes</h3>
                            </div>

                            <div class="row">
                                <div class="owl-carousel featured-carousel-comments owl-theme">
        ...
        @default
            ...
            <div class="gift-card">
                ...
                <button class="gift-button" type="button" data-bs-toggle="modal" data-bs-target="#gift-card-modal">Obtener
                    Tarjeta
                    de Regalo</button>
            </div>
            @include('frontend.modals.gift-card')
