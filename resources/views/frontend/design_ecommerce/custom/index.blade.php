...
@section('content')
    ...
    <section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('design_ecommerce/images/bg-01.jpg');">
        <h2 class="ltext-105 cl0 txt-center">
            Suscríbete para obtener las mejores exclusividades
        </h2>
    </section>
            ...
            <div class="col-sm-10 w-75 col-lg-10 col-xl-10 m-lr-auto m-b-50">
                <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-20 m-r-10 m-lr-0-xl p-lr-15-sm">
                    <form action="{{ url('/suscriptor/store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <center>
                            <button type="submit"
                                class="flex-c-m stext-101 cl0 size-116 w-50 bg3 bor14 text-center hov-btn3 p-lr-15 trans-04 pointer text-white">
                                Suscribirse
                            </button>
                        </center>
