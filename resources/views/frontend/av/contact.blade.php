    ...
    <section class="contact-section">
        <div class="container">
            <div class="d-none d-sm-block mb-5 pb-4">
                ...
                <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAKpjPz3EUHlQ-mqbqNIXlJnWc5NcP8vnU&callback=initMap">
                    async defer >
                </script>
            </div>
                        ...
                        <form action="{{ url('send-email/blog') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="title"
                                    value="¡Formulario enviado desde el apartado de contacto!">
                            </div>
                            <div class="form-group">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>Rincón De Arias, Grecia.</h3>
                            <p>Frente a Bar Pits</p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                        <div class="media-body">
                            <h3>+506 {{ isset($tenantinfo->whatsapp) ? $tenantinfo->whatsapp : '' }}</h3>
                            <p>Lunes a viernes de 8:00 AM a 5:30 PM</p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-email"></i></span>
                        <div class="media-body">
                            <h3>{{ isset($tenantinfo->email) ? $tenantinfo->email : '' }}</h3>
