                    ...
                    @foreach ($clothes as $item)
                        ...
                        <div class="breadcrumb-nav-sk">
                            ...
                            @if (isset($tenantinfo->manage_department) && $tenantinfo->manage_department != 1)
                                ...
                                <li class="bread-sk">
                                    <a href="{{ url('clothes-category/' . $category_id . '/' . $item->department_id) }}">
                                        <i class="fas fa-{{ $icon->services }} me-1"></i> {{ $item->category }}
                                    </a>
                                </li>
                                <li class="bread-sk">
                            ...
                            @else
                                ...
                                <li class="bread-sk">
                                    <a href="{{ url('category/' . $item->department_id) }}">
                                        <i class="fas fa-{{ $icon->categories }} me-1"></i> {{ $item->department_name }}
                                    </a>
                                </li>
                                <li class="bread-sk">
                                    <a href="{{ url('clothes-category/' . $category_id . '/' . $item->department_id) }}">
                                    ...
                                    <main class="col-lg-6">
                                        <div class="ps-lg-3">
                                            ...
                                            <div class="d-flex flex-row my-3 {{ $item->can_buy != 1 ? 'd-none' : '' }}">
                                                @if ($item->trending == 1)
                                                    <div class="text-warning mb-1 me-2">
                                                        ...
                                                        <span class="text-danger my-auto sakura-font">Tendencia</span>

                                                    </div>
                                                @endif
                                                @if (isset($tenantinfo->show_stock) && $tenantinfo->show_stock != 0)
                                                    <span class="text-muted-normal sakura-font"><i
                                                ...
                                                @if ($item->total_stock > 0)
                                                    @if (isset($tenantinfo->tenant) && $tenantinfo->tenant === 'mandicr')
                                                        <span class="text-success sakura-font">
                                                ...
                                                @else
                                                    <span class="text-info sakura-font ms-2">in Stock</span>
                                                @endif
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div
                                                    class="price sakura-color {{ $item->can_buy != 1 && $precioConDescuento <= 0 ? 'd-none' : '' }}">
                                                    ...
                                                    <div class="row">
                                                        @foreach ($result as $attribute)
                                                            @if ($attribute->stock != 0)
                                                                <div class="col-md-12">
                                                                    <label
                                                                        class="sakura-font sakura-color">{{ $attribute->columna_atributo == 'Stock' ? 'Predeterminado' : $attribute->columna_atributo }}</label><br>
                                                                    @php
                    ...
                    <div class="col-md-3 col-sm-6 mb-2">
                        <div class="product-grid product_data">
                            ...
                            <div class="product-content-sk">
                                ...
                                @if (isset($tenantinfo->show_stock) && $tenantinfo->show_stock != 0)
                                    <h6 class="sakura-font sakura-color">
                                        Stock:
                                        @if ($item->total_stock > 0)
                                            {{ $item->total_stock }}
                                        @elseif ($item->total_stock == 0)
                    ...
                    <div class="breadcrumb-nav bc3x mt-4">
                        @if (isset($tenantinfo->manage_department) && $tenantinfo->manage_department != 1)
                            <li class="home"><a href="{{ url('/') }}"><i
                                        class="fas fa-{{ $icon->home }} me-1"></i></a>
                            </li>
