<div id="menuHolder" class="bg-menu-velvet sticky-top">
    <div role="navigation" class="border-bottom bg-menu-velvet" id="mainNavigation">
        ...
        <div class="flexMain">
            <div class="flex2">
                <button class="whiteLink siteLink" id="btnMenu"
                    style="color: var(--navbar_text); border-right:1px solid #eaeaea" onclick="menuToggle()"><i
            ...
            <div class="flex2 text-end d-block d-md-none">
                ...
                @else
                    <a href="{{ url('tenants') }}"><button id="btnIngresar" class="whiteLink siteLink"><i
            ...
            <div class="flex2 text-end d-none d-md-block">
                @guest
                    <a href="{{ route('login') }}">
                        <button id="btnIngresarLogo" class="blackLink siteLink" style="border-right:1px solid #eaeaea"><i
                                class="fa fa-sign-in"></i> INGRESAR</button>
                    </a>
                @else
                    <a href="{{ url('blog/index') }}">
                        <button id="btnIngresarLogo" class="blackLink siteLink" style="border-right:1px solid #eaeaea"><i
                                class="fa fa-book"></i> NUESTRO BLOG</button>
                    </a>
                @endguest
            </div>
        </div>
